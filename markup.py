...
table_data = [
    ...
    ["--------------", "----------------------------"],
    [f"{Fore.LIGHTCYAN_EX}add_contact{Style.RESET_ALL}", "Adds a new contact"],
    [f"{Fore.LIGHTCYAN_EX}del_contact{Style.RESET_ALL}", "Remove a contact"],
    [f"{Fore.LIGHTCYAN_EX}del_phone{Style.RESET_ALL}", "Remove a phone number"],
    [f"{Fore.LIGHTCYAN_EX}change_phone{Style.RESET_ALL}", "Update contact details"],
